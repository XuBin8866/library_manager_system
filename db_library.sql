...
-- ----------------------------
INSERT INTO `tb_bookborrow` VALUES (1, 5, 10, '2020-01-30', '2020-03-03', 'xxbb', 0);
INSERT INTO `tb_bookborrow` VALUES (2, 6, 9, '2020-01-31', '2021-01-10', 'root', 0);
...
INSERT INTO `tb_bookborrow` VALUES (6, 6, 9, '2020-02-04', '2020-03-20', 'root', 0);
...
-- ----------------------------
INSERT INTO `tb_bookinfo` VALUES ('123456', '计算机网络', 4, 'wxy', 'wxy', '302', 128.00, 333, 6, '2020-02-03', 'root', 0, 1);
INSERT INTO `tb_bookinfo` VALUES ('9787302210337', 'Java Web开发实战宝典', 4, '王国辉', 'wgh', '302', 89.00, 834, 4, '2011-02-24', 'root', 0, 7);
INSERT INTO `tb_bookinfo` VALUES ('9787115195975', 'Java Web开发典型模块大全', 4, '王殊', 'ws', '115', 89.00, 752, 5, '2011-02-24', 'root', 0, 8);
INSERT INTO `tb_bookinfo` VALUES ('990821333', 'mysql从入门到精通', 5, 'aabb', 'rc', '115', 11.00, 0, 4, '2011-02-24', 'mr', 0, 9);
INSERT INTO `tb_bookinfo` VALUES ('990823444', 'SpringMVC入门', 4, 'xxbb', 'rc', '111', 26.00, 0, 4, '2011-02-24', 'mr', 0, 10);
...
delimiter ;;
CREATE TRIGGER `delete_trigger` AFTER DELETE ON `tb_manager` FOR EACH ROW delete from tb_purview where id=old.id
;;
delimiter ;
