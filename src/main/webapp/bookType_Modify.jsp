...
<table width="292" height="175" border="0" cellpadding="0" cellspacing="0" background="Images/subBG.jpg">
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td><table width="100%" height="131"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center" valign="top"><form name="form1" method="post" action="book?action=bookTypeModify">
 <input name="id" type="hidden" size="50" value="${id }"> 
  ...
  <tr>
    ...
    <td width="71%"><input name="typeName" type="text" size="30" value="${name }">
      </td>
  </tr>
  <tr>
    <td align="center">可借天数：</td>
    <td><input name="time" type="text" size="25" value="${time }">
      (天)</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
