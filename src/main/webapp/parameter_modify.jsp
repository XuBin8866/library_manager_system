...
<%@ page import="com.xxbb.actionform.ParameterForm" %>
<head>
<title>图书馆管理系统</title>
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="center">
    ...
    <td width="76%" align="left">
      <input name="cost" type="text" id="cost" value="${p.cost }" size="30"/>
      (元)    </td>
    <tr>
    <input name="id" type="hidden" value="${p.id }">
    <td align="left" style="padding:5px;">有效期限：</td>
    <td align="left"><input name="validity" type="text" id="validity" size="30" value="${p.validity }" />
      (月)</td>
    </tr>
    <tr>
