...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
...
</table>  <form name="form1" method="post" action="manager?action=pwdmodify">
  ...
  <tr align="center">
    ...
    <td align="left">
      <input name="oldpwd" type="text" id="oldpwd" size="30"/>
      <input name="holdpwd" type="hidden" id="holdpwd" value="${manager.pwd }"/></td>
    </tr>
    <tr>
